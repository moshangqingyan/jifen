...
<span class="content" onclick="window.location.href = 'rank'">
    <div class="row">
        <div class="col-md-9 col-xs-9"><span href="#">他的打分记录
                <span class="badge" style="background-color: green">{{ $count }}</span></span>
        </div>
